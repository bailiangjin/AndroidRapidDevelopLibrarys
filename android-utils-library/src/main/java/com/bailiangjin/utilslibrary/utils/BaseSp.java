...
public abstract class BaseSp {
    ...
    public BaseSp(String spFileName) {
    ...
    private SharedPreferences getSp() {
        String userId = TextUtils.isEmpty(getUserId()) ? "" : getUserId();
        return getSp(userId + this.mSpFileName);
    }

    private SharedPreferences getSp(String spFileName) {
        return getContext().getSharedPreferences(spFileName, Context.MODE_PRIVATE);
    }
